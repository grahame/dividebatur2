...
#[derive(Debug, Clone)]
/// a summary of the state of the count, after a given count.
/// referred to when breaking ties for candidate election or
/// exclusion
...
#[derive(Debug)]
/// all bundle transactions held by a candidate in a given count
